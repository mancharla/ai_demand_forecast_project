...
function Reports() {
  ...
  const handleAnalyticsSummaryDownload = async () => {
      try {
        setLoadingAnalytics(true);

        const response = await downloadAnalyticsSummary();
        ...
        console.error(
          "Analytics summary download failed",
          error
        );
        alert(
          error.response?.data?.detail ||
    ...
    <PageLayout>
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <ActionCard
            icon="📑"
            title="Download Analytics Summary"
            description="Export the complete analytics summary as an Excel file."
            buttonText="Download Summary"
            buttonColor="bg-purple-600 hover:bg-purple-700"
            loading={loadingAnalytics}
            onClick={handleAnalyticsSummaryDownload}
          />
        </div>
      </div>
    </PageLayout>
