      ...
      <div className="space-y-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <div className="border-2 border-dashed border-blue-300 rounded-3xl p-10 text-center bg-blue-50 hover:bg-blue-100 transition-all duration-300">
              <input
                type="file"
                accept=".csv,.xlsx"
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            {!datasetInfo ? (
              <div className="text-gray-500 bg-gray-50 p-6 rounded-2xl">
